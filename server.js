...
async function addEmployee() {
    try {
        ...
        const getRoles = connection.query(`SELECT title as name, id as value FROM role`);
...
async function updateJobTitle() {
    try {
        ...
        const [titlesResult] = await connection.query(`SELECT title as name, id as value FROM role`);
...
async function addJobTitle() {
    try {
        ...
        await connection.query('INSERT INTO role SET ?', userInput);
